...
#Testing (colorspace): ffmpeg -i $in -r $fps_in -vf "scale=iw/$scale:ih/$scale, colorchannelmixer=.393:.769:.189:.349:.686:.168:.272:.534:.131" $tmp/roboflow_in/frame%05d.jpg
